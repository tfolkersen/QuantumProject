...
o4 = ((p9*q2 + p8*q3 + p7*q4 + p6*q5 + p5*q6 + p5*q6 + p4*q7 + p3*q8 + p2*q9 + c7) + 2*(p9*q3 + p8*q4 + p7*q5 + p6*q6 + p5*q7 + p4*q8 + p3*q9 + c8) + 4*(p9*q4 + p8*q5 + p7*q6 + p6*q7 + p5*q8 + p4*q9 + c9) - n11 - 2*n12 - 4*n13 - 8*c11 - 16*c12 - 32*c13)**2
